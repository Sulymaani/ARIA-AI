  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", gap:16, width:"100%" }}>
      <style>{`
        ...
        @keytml sk3{0%,100%{transform:translate(0,0)}45%{transform:translate(6px,8px)}80%{transform:translate(-10px,-5px)}}
        @keyframes shimmer{0%,100%{opacity:.25}50%{opacity:.5}}
      `}</style>
      {[{h:130,w:"100%",a:"sk1 3.2s ease-in-out infinite"},{h:90,w:"72%",a:"sk2 3.8s ease-in-out infinite"},{h:110,w:"88%",a:"sk1 4.1s ease-in-out .4s infinite"}].map((s,i)=>(
      ...
      <div style={{ color:C.text2, fontSize:13, textAlign:"center", marginTop:4, letterSpacing:"0.06em", fontWeight:500 }}>
        ARIA is generating your interface...
      </div>
    </div>
  )
}
